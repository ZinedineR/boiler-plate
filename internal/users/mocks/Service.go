...
func (_m *Service) Detail(ctx context.Context, id string) (*domain.Users, *exception.Exception) {
	ret := _m.Called(ctx, id)
...
func (_m *Service) Find(ctx context.Context) (*[]domain.Users, *exception.Exception) {
	ret := _m.Called(ctx)
	...
	if rf, ok := ret.Get(0).(func(context.Context) *[]domain.Users); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*[]domain.Users)
